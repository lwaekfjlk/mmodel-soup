...
def main(args, config):
    ...
    for epoch in range(0, max_epoch):
        ...
        with open(os.path.join(args.output_dir, "urfunny_vision_text_label_test.jsonl"), "w") as f:
            f.write("")
        
        with open(os.path.join(args.output_dir, "urfunny_vision_text_label_test.jsonl"), "a") as f:
