...
def main(args, config):
    ...
    for epoch in range(0, max_epoch):
        ...
        with open(os.path.join(args.output_dir, "mmsd_vision_text_logits.jsonl"), "w") as f:
            f.write("")
        
        with open(os.path.join(args.output_dir, "mmsd_vision_text_logits.jsonl"), "a") as f:
