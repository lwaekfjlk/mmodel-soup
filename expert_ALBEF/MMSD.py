...
def main(args, config):
    ...
    datasets = create_dataset("sarc-detect", config)
    ...
    for epoch in range(0, max_epoch):
        ...
        with open(
            os.path.join(args.output_dir, "mmsd_vision_text_label_test.jsonl"), "w"
        ) as f:
            f.write("")

        with open(
            os.path.join(args.output_dir, "mmsd_vision_text_label_test.jsonl"), "a"
        ) as f:
