...
if __name__ == "__main__":
    ...
    print(
        "Weighted Average Fusion Accuracy:",
        weighted_average_fusion(transformed_results, weighted_weights),
    )
    ...
    for threshold in [0.5, 0.6, 0.7, 0.8, 0.9]:
        print(
            f"Cascaded Fusion Accuracy (Threshold={threshold}):",
            cascaded_fusion(transformed_results, threshold),
        )
    print(
        "AS Interaction Type Accuracy:", interaction_type_acc(transformed_results, "AS")
    )
    print(
        "R Interaction Type Accuracy:", interaction_type_acc(transformed_results, "R")
    )
    print(
        "U Interaction Type Accuracy:", interaction_type_acc(transformed_results, "U")
    )
    baseline_dataset, baseline_results = load_and_transform_baseline(file_dir)
    print(
        "Baseline Interaction Type Accuracy:",
        interaction_type_acc(baseline_results, "baseline"),
    )
