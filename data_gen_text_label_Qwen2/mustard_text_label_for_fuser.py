...
import litellm
from utils import (calculate_f1, get_prediction, load_ids, prompt_llm,
                   save_results)
...
def main():
    ...
    parser.add_argument(
        "--save_file",
        type=str,
        default="../mustard_data/data_gen_output/mustard_text_only_pred_qwen2_for_fuser.json",
        help="save file path",
    )
    ...
    train_results = get_prediction(
        {k: v for k, v in results.items() if k in train_ids}, 0, split="test"
    )
