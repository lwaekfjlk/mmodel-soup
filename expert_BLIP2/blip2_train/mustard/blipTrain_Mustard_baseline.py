...
def train(model, train_dataloader, val_dataloader, tokenizer, device, epochs=5):
    ...
    acc, f1, precision, recall, total_yesno_logits = evaluate(model, val_dataloader, device, yes_token_id, no_token_id)
...
if __name__ == '__main__':
    # path to data  
    train_path = '/root/haofeiy/mmodel-soup/expert_BLIP2/dataset/mustard_train.json'
    val_path = '/root/haofeiy/mmodel-soup/expert_BLIP2/dataset/mustard_test.json'
