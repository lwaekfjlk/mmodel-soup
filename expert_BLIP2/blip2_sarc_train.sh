...
--val_path ../sarc_data/data_split_output/sarc_AS_dataset_val.json \
...
--val_path ../sarc_data/data_split_output/sarc_R_dataset_val.json \
--test_path ../sarc_data/data_raw/sarc_dataset_test.json \
--image_data_path ../sarc_data/data_raw/images \
...
--val_path ../sarc_data/data_split_output/sarc_U_dataset_val.json \
--test_path ../sarc_data/data_raw/sarc_dataset_test.json \
--image_data_path ../sarc_data/data_raw/images \
...
--val_path ../sarc_data/data_raw/sarc_dataset_val.json \
--test_path ../sarc_data/data_raw/sarc_dataset_test.json \
--image_data_path ../sarc_data/data_raw/images \
