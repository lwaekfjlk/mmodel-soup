...
--load_model_name 7_qwen_mustard_U_model \
...
--test_path ../mustard_data/data_raw/mustard_dataset_test.json \
--image_data_path ../mustard_data/data_raw/images \
--load_model_name 7_qwen_mustard_AS_model \
--save_path ./qwen_mustard_test_model \
--batch_size 1 \
--eval_steps 10 \
--epochs 5 \
...
--test_path ../mustard_data/data_raw/mustard_dataset_test.json \
--image_data_path ../mustard_data/data_raw/images \
--load_model_name 7_qwen_mustard_R_model \
--save_path ./qwen_mustard_test_model \
--batch_size 1 \
--eval_steps 10 \
--epochs 5 \
...
--test_path ../mustard_data/data_raw/mustard_dataset_test.json \
--image_data_path ../mustard_data/data_raw/images \
--load_model_name 7_qwen_mustard_baseline_model \
