...
def main():
    ...
    train_dataset = read_json_file('../../mustard_data/data_raw/mustard_dataset_test.json')
    
    R_dataset = construct_subset(R_ids, train_dataset)
    save_dataset('../../mustard_data/data_split_output/mustard_R_dataset_test.json', R_dataset)
    
    AS_dataset = construct_subset(AS_ids, train_dataset)
    save_dataset('../../mustard_data/data_split_output/mustard_AS_dataset_test.json', AS_dataset)
    
    U_dataset = construct_subset(U_ids, train_dataset)
    save_dataset('../../mustard_data/data_split_output/mustard_U_dataset_test.json', U_dataset)
